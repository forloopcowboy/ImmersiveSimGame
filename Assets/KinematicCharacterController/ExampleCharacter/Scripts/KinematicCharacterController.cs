                ...
                case CharacterState.Default:
                    {
                        ...
                        else if (inputs.SprintUp) _sprintRequested = false;
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (Motor.GroundingStatus.IsStableOnGround)
                        {
                            ...
                            // Handle sprinting
                            if (_sprintRequested) AddVelocity(reorientedInput * (MaxStableMoveSpeed * SprintMultiplier));
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (_isCrouching && !_shouldBeCrouching)
                        {
                            ...
                            Motor.SetCapsuleDimensions(0.35f, 1.75f, 0.9f);
                                ...
                                QueryTriggerInteraction.Ignore) > 0)
                            {
                                ...
                                Motor.SetCapsuleDimensions(0.35f, CrouchedCapsuleHeight, CrouchedCapsuleHeight * 0.5f);
                            }
                            else
                            {
